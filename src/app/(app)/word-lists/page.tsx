        ...
        <div className="flex min-h-[calc(100vh-72px)]">
          ...
          <section className="flex min-w-0 flex-1">
            <div className="min-w-0 flex-1 px-8 py-9">
              ...
              <form action={updateWordLists} className="mt-8" id="word-lists-form">

                <div className="mt-8 flex items-center justify-between text-[15px] text-[#6B7280]">
                  <span>{visibleLists.length} lists available</span>
                  <span>{dashboardData.selectedCount} selected</span>
                </div>
                ...
                <div className="mt-5 space-y-4">
                  {visibleLists.map((list) => (
                    ...
                    >
                      ...
                      <input
                        className="sr-only"
                        defaultChecked={list.isSelected}
                        name="wordListId"
                        type="checkbox"
                        value={list.id}
                      />
